"""
Wind Sensor IoT Device
Publishes wind speed readings via MQTT and exposes CoAP endpoint
"""
...
class WindSensor:
    ...
    def __init__(self):
        ...
        self.sensor_id = os.getenv('SENSOR_ID', 'wind-01')
        self.sensor_type = os.getenv('SENSOR_TYPE', 'wind')
        ...
        self.publish_interval = int(os.getenv('PUBLISH_INTERVAL', '12'))
